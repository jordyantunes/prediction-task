...
def train(rnn: RNN, optimizer, criterion, category_tensor, line_tensor):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o", type=Path, default=Path("./weights.pt"), help="destination for weights"
    )
    parser.add_argument(
        "-p",
        type=Path,
        default=Path("./params.json"),
        help="destination for parameters",
    )
    ...
    category_lines, all_categories, n_categories = prepare_data()
